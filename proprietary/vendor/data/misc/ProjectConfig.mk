...
CUSTOM_HAL_IMGSENSOR = s5kgm1sp_mipi_raw s5k3p9_mipi_raw s5k4h7_mipi_raw s5k3p9main_mipi_raw
CUSTOM_HAL_LENS = dw9714af bu6429af ak7371af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k4h7_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1sp_mipi_raw s5k3p9main_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5kgm1sp_mipi_raw s5k3p9_mipi_raw s5k4h7_mipi_raw s5k3p9main_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af bu6429af ak7371af dummy_lens
CUSTOM_KERNEL_LINEARACCEL_SENSOR = no
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = s5k4h7_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1sp_mipi_raw s5k3p9main_mipi_raw 
...
CUSTOM_MODEM = X90-LWCTG_6779-G2358W12458F12345781213171819202526286671T3438394041BC01_hotswap
...
MTK_BUILD_VERNO = alps-mp-p0.mp3
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 2
...
#prize modify YZHD,for cts,20190731,begin
MTK_OMAPI_SUPPORT = no
#prize modify YZHD,for cts,20190731,end
...
#Prize-软件版本号-20190710
PRIZE_SW_VERSION= X90T88C.GQU.Ulefone.EEA.HB.FHD.$(PRIZE_FLASH_CODE).$(shell date +%m%d).V3.01
#Prize-software version-20190710
...
PRIZE_BOARD_NETWORK_TYPE = GB/WB/TB/CB/LtB/LfB
#配置工厂测试类型
...
PRIZE_HEART_RATE = yes

#硬件计步导致CTS fail，解决问题用此宏控制
PRIZE_HW_STEP_COUNTER_FOR_GMS = yes
#add by lipengpeng 20191008 start
PRIZE_DOUJIA_DOG_FREE=yes
#add by lipengpeng 20191008 end
